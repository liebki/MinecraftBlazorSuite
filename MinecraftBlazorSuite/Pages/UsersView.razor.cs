...
namespace MinecraftBlazorSuite.Pages
{
    ...
    {
        [Inject]
        public SqliteManager sqliteMan { get; set; }

        private PanelUser newUser = new PanelUser();
        ...
        private async Task CreateUser()
        {
            ...
            userList.Add(new PanelUser { Id = userId, Username = newUser.Username, Rights = newUser.Rights, LastLoginIp = newUser.LastLoginIp });
        ...
        private List<PanelUser> userList = new List<PanelUser>();
