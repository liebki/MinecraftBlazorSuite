...
partial class MainLayout
{
    ...
    [Inject] 
    public NotificationService notifyServ { get; set; }
    
    [Inject] 
    public ISnackbar snackbarServ { get; set; }
    ...
    {
        snackbarServ.Add(message:msg.message, severity:msg.severity, configure:config =>
        {
